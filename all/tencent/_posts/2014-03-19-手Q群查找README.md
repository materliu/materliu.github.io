...
3. 上报代码 任何一个页面，对于点击上报数据只监听 [data-report-dc] 属性选择器， 有此属性选择器，则取其值进行dc上报， data-report-dc的格式如下：data-report-dc-str="opername=Grp_tribe,module=join_list,action=Clk_recom,ver1={{banner.bid}}" 具体代码参考如下：
